...
/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ "./src/style.css");
/* harmony import */ var _model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./model */ "./src/model.js");
/* harmony import */ var _querySelectors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./querySelectors */ "./src/querySelectors.js");
/* harmony import */ var _dates__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./dates */ "./src/dates.js");
...
function selectAddType() {
  _querySelectors__WEBPACK_IMPORTED_MODULE_2__.addCategoryMsg.style.display = "none";
  _querySelectors__WEBPACK_IMPORTED_MODULE_2__.selectAddTypeDiv.style.display = "initial";
  if (_querySelectors__WEBPACK_IMPORTED_MODULE_2__.selectAddTypeDiv.style.display === "initial") {
    _querySelectors__WEBPACK_IMPORTED_MODULE_2__.sideNav.classList.add("cat-form-visible");
  } else {
    _querySelectors__WEBPACK_IMPORTED_MODULE_2__.sideNav.classList.remove("cat-form-visible");
  }
}

function showCatMessage() {
  _querySelectors__WEBPACK_IMPORTED_MODULE_2__.addCategoryMsg.style.display = "initial";

  console.log(_querySelectors__WEBPACK_IMPORTED_MODULE_2__.addCategoryMsg.style.display);
}

function displayCategoryWarning() {
  _querySelectors__WEBPACK_IMPORTED_MODULE_2__.categoryWarning.style.display = "initial";
  _querySelectors__WEBPACK_IMPORTED_MODULE_2__.selectAddTypeDiv.style.display = "none";
}

function closeToDoWarning() {
  _querySelectors__WEBPACK_IMPORTED_MODULE_2__.categoryWarning.style.display = "none";
  _querySelectors__WEBPACK_IMPORTED_MODULE_2__.categoryFormBox.style.display = "initial";
}
...
function newCategoryForm() {
  _querySelectors__WEBPACK_IMPORTED_MODULE_2__.selectAddTypeDiv.style.display = "none";
  _querySelectors__WEBPACK_IMPORTED_MODULE_2__.categoryFormBox.style.display = "initial";
  _querySelectors__WEBPACK_IMPORTED_MODULE_2__.categoryTab.classList.add("tab-content--active");

  if (_querySelectors__WEBPACK_IMPORTED_MODULE_2__.categoryFormBox.style.display === "initial") {
    _querySelectors__WEBPACK_IMPORTED_MODULE_2__.sideNav.classList.add("cat-form-visible");
  }
}

function hideCategoryForm() {
  _querySelectors__WEBPACK_IMPORTED_MODULE_2__.categoryFormBox.style.display = "none";
  _querySelectors__WEBPACK_IMPORTED_MODULE_2__.categoryForm.reset();
  _querySelectors__WEBPACK_IMPORTED_MODULE_2__.addCategoryMsg.style.display = "initial";
  _querySelectors__WEBPACK_IMPORTED_MODULE_2__.sideNav.classList.remove("cat-form-visible");
}
...
function createCategorySection() {
  ...
  console.log(_model__WEBPACK_IMPORTED_MODULE_1__.categoriesArray);

  for (let i = 0; i < _model__WEBPACK_IMPORTED_MODULE_1__.categoriesArray.length; i++) {
    ...
    cardCategoryName.textContent = `${_model__WEBPACK_IMPORTED_MODULE_1__.categoriesArray[i]}`;

    const categoryContent = document.createElement("div");
    categoryContent.className = "cat-content";
    categoryContent.dataset.content = `${_model__WEBPACK_IMPORTED_MODULE_1__.categoriesArray[i]}`;
    ...
    addItemBtn.setAttribute("data-category", `${_model__WEBPACK_IMPORTED_MODULE_1__.categoriesArray[i]}`);
    ...
    deleteIconContainer.setAttribute(
      "data-delete-cat",
      `${_model__WEBPACK_IMPORTED_MODULE_1__.categoriesArray[i]}`
    );
    deleteIconContainer.setAttribute("data-delete-cat-index", i);

    const deleteBtnImg = document.createElement("img");
    deleteBtnImg.src = "../src/assets/imgs/trash.svg";
    deleteBtnImg.setAttribute("data-delete-cat", `${_model__WEBPACK_IMPORTED_MODULE_1__.categoriesArray[i]}`);
    ...
    _querySelectors__WEBPACK_IMPORTED_MODULE_2__.categorySection.appendChild(categoryCard);
...
function replaceCategorySections() {
  ...
  while (_querySelectors__WEBPACK_IMPORTED_MODULE_2__.categorySection.firstChild) {
    _querySelectors__WEBPACK_IMPORTED_MODULE_2__.categorySection.removeChild(_querySelectors__WEBPACK_IMPORTED_MODULE_2__.categorySection.firstChild);
  }
}

function toDoFormDisplay(addBtn) {
  console.log(addBtn);
  _querySelectors__WEBPACK_IMPORTED_MODULE_2__.categoryName.textContent = addBtn;

  _querySelectors__WEBPACK_IMPORTED_MODULE_2__.toDoFormContainer.style.display = "initial";
  _querySelectors__WEBPACK_IMPORTED_MODULE_2__.toDoFormContainer.scrollTo(0, 0);
  _querySelectors__WEBPACK_IMPORTED_MODULE_2__.addToDoBtn.style.display = "initial";
  _querySelectors__WEBPACK_IMPORTED_MODULE_2__.editToDoBtn.style.display = "none";
  (0,_dates__WEBPACK_IMPORTED_MODULE_3__.limitDatePicker)();
}
...
function showFormWithInfo(editBtnIndex, editBtnCat) {
  for (let i = 0; i < _model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray.length; i++) {
    _querySelectors__WEBPACK_IMPORTED_MODULE_2__.toDoFormContainer.style.display = "initial";
    _querySelectors__WEBPACK_IMPORTED_MODULE_2__.toDoFormContainer.scrollTo(0, 0);
    _querySelectors__WEBPACK_IMPORTED_MODULE_2__.addToDoBtn.style.display = "none";
    _querySelectors__WEBPACK_IMPORTED_MODULE_2__.editToDoBtn.style.display = "initial";
    (0,_dates__WEBPACK_IMPORTED_MODULE_3__.limitDatePicker)();

    if (
      parseInt(editBtnIndex) ===
      parseInt(_model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray.indexOf(_model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i]))
    ) {
      _querySelectors__WEBPACK_IMPORTED_MODULE_2__.categoryName.textContent = editBtnCat;
      _querySelectors__WEBPACK_IMPORTED_MODULE_2__.toDoTitle.value = _model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].title;
      _querySelectors__WEBPACK_IMPORTED_MODULE_2__.toDoPriority.value = _model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].priority;
      _querySelectors__WEBPACK_IMPORTED_MODULE_2__.toDoDescription.value = _model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].description;
      _querySelectors__WEBPACK_IMPORTED_MODULE_2__.toDoDueDate.value = _model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].dueDate;
    }

    const entryIndex = _model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray.indexOf(_model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i]);
  }
}

function hideToDoForm() {
  _querySelectors__WEBPACK_IMPORTED_MODULE_2__.toDoFormContainer.style.display = "none";
  _querySelectors__WEBPACK_IMPORTED_MODULE_2__.toDoForm.reset();
}

function displayToDoEntry() {
  for (let i = 0; i < _model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray.length; i++) {
    if (_model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].completedTask === false) {
      ...
      toDoTitle.textContent = _model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].title;
      ...
      if (_model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].description === "") {
        toDoDetailsTitle.style.display = "none";
      }

      const toDoDetails = document.createElement("p");
      toDoDetails.className = "details";
      toDoDetails.textContent = _model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].description;
      ...
      toDoDueDate.textContent = _model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].dueDate;
      ...
      if (_model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].priority.toLowerCase() === "low") {
        priorityColor.style.backgroundColor = "#e7f24f";
      } else if (_model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].priority.toLowerCase() === "medium") {
        priorityColor.style.backgroundColor = "#eeb250";
      } else if (_model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].priority.toLowerCase === "high") {
      ...
      editIcon.setAttribute("data-edit-cat", _model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].category);
      editIcon.setAttribute("focusable", true);
      editIcon.setAttribute("tabindex", 0);

      catContentDivs.forEach((div) => {
        if (_model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].category === div.dataset.content) {
...
function showByDueDate() {
  for (let i = 0; i < _model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray.length; i++) {
    if (_model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].completedTask === false) {
      ...
      dueViewDueDate.textContent = _model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].dueDate;
      ...
      dueDateTitle.textContent = _model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].title;

      const dueDateDescription = document.createElement("div");
      dueDateDescription.className = "grid-cells .due-view-description";
      if (_model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].description !== "") {
        dueDateDescription.textContent = _model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].description;
      } else {
      ...
      dueDateCheckbox.checked = _model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].completedTask;
      ...
      _querySelectors__WEBPACK_IMPORTED_MODULE_2__.dueDateTaskDiv.appendChild(dueDateTasksRowDiv);
...
function showByPriority() {
  for (let i = 0; i < _model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray.length; i++) {
    if (_model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].completedTask === false) {
      ...
      priorityTitle.textContent = _model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].title;

      const priorityDescription = document.createElement("div");
      priorityDescription.className = "grid-cells .priority-view-description";
      if (_model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].description !== "") {
        priorityDescription.textContent = _model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].description;
      } else {
      ...
      priorityViewDueDate.textContent = _model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].dueDate;
      ...
      priorityCheckbox.checked = _model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].completedTask;
      ...
      _querySelectors__WEBPACK_IMPORTED_MODULE_2__.priorityTaskDiv.appendChild(priorityTasksRowDiv);
...
function showCompletedTasks() {
  for (let i = 0; i < _model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray.length; i++) {
    if (_model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].completedTask === true) {
      ...
      completedCheckbox.checked = _model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].completedTask;
      ...
      gridCellsTitle.textContent = _model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].title;

      const gridCellsDescription = document.createElement("div");
      gridCellsDescription.className = "grid-cells .complete-view-description";
      if (_model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].description !== "") {
        gridCellsDescription.textContent = _model__WEBPACK_IMPORTED_MODULE_1__.toDoItemsArray[i].description;
      } else {
      ...
      _querySelectors__WEBPACK_IMPORTED_MODULE_2__.completedTasksDiv.appendChild(completedTasksRowDiv);
